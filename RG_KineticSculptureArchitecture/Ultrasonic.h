...
class Ultrasonic {
  public:
     ...
     * 
     * @return the distance of the object from the ultrasonic sensor in CM
     */
    int getDistanceInCM(){
      startMeasurement();
      return distance;
     ...
     * 
     * @return the distance of the object from the ultrasonic sensor in inches
     */
     ...
     * 
     * @return If the ultrasonic sensor is runnning a measurment.
     **/
    bool inProgress(){
      return IN_PROGRESS;
    }
